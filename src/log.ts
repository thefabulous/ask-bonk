...
function emit(level: LogLevel, event: string, context: LogContext, data: Record<string, unknown> = {}): void {
...
export function createLogger(context: LogContext = {}): Logger {
	...
	return {
		...
		errorWithException: (event, err, data = {}) => emit('error', event, baseContext, { ...data, ...formatError(err) }),
